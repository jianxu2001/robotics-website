...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    title: "Automated 3D Vision Bag Breaking and Palletizing Solution for a Chemical Factory",
    industry: "Chemical manufacturing, powder handling, bag breaking, palletizing",
    ...
    inquiryData: ["Bag size, material, and unit weight", "Target throughput and shift schedule", "Pallet size, stack height, and pattern", "Factory layout, dust-control requirements, and conveyor interface"],
  },
];
